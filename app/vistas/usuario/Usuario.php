...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                <form id="formUsuario" action="usuario/registrarUsuario" method="post">
            ...
            <div class="box">
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="gridUsuarios" class="table table-bordered table-striped" style="font-size: 12px;">
                        <thead>
                            <tr>
                                <th>Nombre</th>
                                <th>Login</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        conn = new WebSocket('ws://178.128.149.94:8080');//conectara
